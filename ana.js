...
function sr(e) {
  ...
  if (n) {
    ...
    if (c > 0 && d > 0 && Math.random() < 0.2 && (t.push(ir.fu), f = !0), i >= 2) {
      ...
      var v = (0, l.Z)(ir.nPM);
      (c > 0 && d > 0 || g) &&
        (v = (0, l.Z)(v).concat((0, l.Z)(ir.nPP))),
        (d > 0 || g) &&
        (v = (0, l.Z)(v).concat((0, l.Z)(ir.nPA))),
        g &&
        t.push(ir.fwf),
        f &&
        t.push(ir.fwm),
  ...
  for (var w = 0; w < c; w++) {
    ...
    n &&
      ...
      Math.random() < 0.2 &&
      (k = !0, t.push(ir.fu)),
      (j = t).push.apply(j, (0, l.Z)(or(k ? 'fu' : 'f', p, n, i)))
  }
  for (var S = 0; S < d; S++) {
    var I;
    (I = t).push.apply(I, (0, l.Z)(or('m', p, n, i)))
  }
  for (var C = 0; C < u; C++) {
    var Z;
    (Z = t).push.apply(Z, (0, l.Z)(or('o', p, n, i)))
  }
  if (Math.random() < 0.2) {
    var M = rr(4)
    2 === i &&
...
function or(e, t, n, i) {
  ...
  Math.random() < 0.6 &&
    ...
    r.push(
      ar(
        (0, l.Z)(Ji).concat(
          (0, l.Z)(n ? (0, l.Z)(ir.nSM).concat((0, l.Z)(ir.nSA), (0, l.Z)(ir.nSP)) : [])
        ),
        r
      )
    ),
  ...
  for (var k = 0; k < j; k++) r.push(ar((0, l.Z)(Ui).concat((0, l.Z)(n ? ir.nEx : [])), r))
  return a &&
    r.filter((function (e) {
